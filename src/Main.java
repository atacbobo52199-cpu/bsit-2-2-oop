// Main.java
// This file is COMPLETE. Do not change it. It is the menu that tests your work.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            if (choice.equals("1")) {
                ...
                System.out.println(
                        "Unknown choice. Please pick 0 to 6."
                );
            }
        }
    }
    ...
    private static void makePayment() {
        ...
        System.out.println();
        System.out.println(
                "Payment method:  1 = GCash   2 = Maya   3 = Cash"
        );
        ...
        if (method.equals("1")) {
            ...
            System.out.println(
                    "Unknown method. The payment was not recorded."
            );
    ...
    private static double readDouble() {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.print(
                        "That is not an amount. Try again: "
                );
            }
        }
    }
